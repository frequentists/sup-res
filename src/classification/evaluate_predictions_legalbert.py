...
for n_labels in ["10000", "20000", "50000"]:
	...
	fn = "classification-predictions/legal-bert-base-uncased-" + n_labels + "/predictions_devset_" + n_labels + ".json"
	with open(fn) as f:
		data = json.load(f)
	...
	fn = "classification-predictions/legal-bert-base-uncased-" + n_labels + "/predictions_testset_" + n_labels + ".json"
	with open(fn) as f:
		data = json.load(f)
